...
- ~~Never run `just record-current` against a checkout that has already been symlinked to Agent Stack.~~ **Retired 20260903** with upstream sync; the recipe no longer exists.

## Why the retired second rule was here despite being narrow
