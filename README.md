...
## Governance
- Repo-local guidance: [AGENTS.md](/Volumes/Data/_ai/_mcp/skills_stuff/AGENTS.md)
- Local governance index: [governance/README.md](/Volumes/Data/_ai/_mcp/skills_stuff/governance/README.md)
...
- Use governed commit messages and update [REVISION_HISTORY.md](/Volumes/Data/_ai/_mcp/skills_stuff/REVISION_HISTORY.md) when publishing meaningful repo changes.
